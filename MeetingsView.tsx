    ...
    onSuccess: ({ activated, login }) => {
      if (activated) {
        ...
        toastSuccess({
          ...
          description: t(
            "meetings:feedbacks.deactivateUserSuccess.description",
            { login }
          ),
        });
      }
          ...
          {meetings?.meetings
            ...
            .map((user) => (
              <DataListRow as={LinkBox} key={user.id}>
                  ...
                  <HStack maxW="100%">
                    ...
                    <Box minW="0">
                      <Text noOfLines={1} maxW="full" fontWeight="bold">
                        {getContactName(
                          user.associations?.contacts?.results[0]?.id || ""
                        )}
                      </Text>
                      <Text
                        noOfLines={1}
                ...
                >
                  <Text noOfLines={1} maxW="full">
                    {user.properties.hs_internal_meeting_notes ||
                      user.properties.hs_meeting_outcome}
                  </Text>
                </DataListCell>
