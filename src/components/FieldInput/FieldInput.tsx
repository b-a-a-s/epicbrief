...
import { IconButton, Input, InputGroup, InputLeftElement, InputProps, InputRightElement, Spinner } from '@chakra-ui/react';
...
export const FieldInput = (props: FieldInputProps) => {
  const { errorMessage, id, isValid, isPristine, isSubmitted, isValidating, resetKey, setValue, value, otherProps } = useField(props);
  const {
    children,
    label,
    type,
